...
pengguna dan sistem MONTREAL-VT.
\begin{figure}[htb!]
    \centering
...
Pada gambar \ref{fig:use_case}, aktor utama dari sistem
adalah administrator atau user yang memiliki bertanggung jawab
dalam pengoperasian dan pengawasan platform monitoring. 
User memiliki hak akses untuk memulai sistem, mengakses data melalui
...
\subsubsection{Perhitungan Batas Arus Motor Maksimum}
    ...
    \begin{align}
        P_{rated}=V_{rated} I_{rated} cos(\Theta) \eta\\ \label{eq:rating_daya}
        I_{rated}=\frac{P_{rated}}{V_{rated} \cos(\Theta) \eta}\\         \label{eq:rating_arus}
    \end{align}

    Rumus rating arus diimplementasikan untuk menetapkan 
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.8\textwidth]{image/doc/skematik-monitor-2.pdf} % Ganti dengan path diagram Anda
...
\begin{figure}[t!]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{3D View PCB Tampak Depan}
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{3D View PCB Tampak Belakang}
...
%     \begin{minipage}{0.48\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{image/doc/motor-assembled.jpg}
%         \caption{Konstruksi Motor Induksi Penelitian}
%         \label{fig:motor-assembled}
%     \end{minipage}
%     \hfill
%     \begin{minipage}{0.48\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{image/doc/motor-disassembled.jpg}
%         \caption{Konstruksi Motor Induksi Penelitian (disassembled)}
%         \label{fig:motor-disassembled}
%     \end{minipage}
% \end{figure}
