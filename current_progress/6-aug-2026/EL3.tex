...
\subsubsection{Perhitungan Batas Suhu Housing Maksimum}
    ...
    \begin{tabular}{|p{3cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|}
        ...
        \hline
        \textbf{Batas Kenaikan Suhu} & 80 & 80 & n & n & n & n\\
        \hline
    \end{tabular}
    \end{table}
...
Basis Data (CHBD), dan subsitem Desain Alarm
...
pada subsistem isps digambarkan oleh gambar \ref{fig:flowchart_isps_1}
...
Subsistem ISPS bertanggung jawab pada alur kerja
sistem sensor, pemrosesan sinyal output sensor
, serta proses akuisisi data melalui sensor dan
mikrokontroler.
...
Subsistem Cloud-Hosting dan Basis Data (CBD) bertugas 
menghubungkan perangkat keras ke sistem serverless melalui
layanan cloud.
...
\subsubsection*{Alternatif 1: Mikrokontroler ESP32-S3, Edge Computing}
\begin{enumerate}
    \item \textbf{Deskripsi:} Pemrosesan lebih lanjut dilakukan secara lokal pada mikrokontroler ESP32-S3.
    \item \textbf{Alasan Penolakan:} Meskipun pemrosesan lokal dapat mengurangi ketergantungan pada koneksi internet, hal ini membatasi kemampuan sistem untuk menyimpan data historis dan melakukan analisis yang lebih kompleks. Selain itu, keterbatasan sumber daya pada mikrokontroler dapat membatasi skalabilitas dan fleksibilitas sistem di masa depan.
\end{enumerate}

\subsubsection*{Alternatif 2: Raspberry Pi 4, Edge Computing}
\begin{enumerate}
    \item \textbf{Deskripsi:} Mengganti mikrokontroler ESP32-S3 dengan Raspberry Pi 4 untuk pemrosesan data secara lokal.
    \item \textbf{Alasan Penolakan:} Raspberry Pi 4 menawarkan kemampuan pemrosesan yang lebih tinggi, tetapi juga meningkatkan kompleksitas sistem, konsumsi daya, dan
\end{enumerate}   
